      ...
      <div class="hero-unit">
        ...
        <p><a class="btn btn-primary btn-large" href="/vis_tools">Visualization Tools <i class="icon-chevron-right icon-white"></i></a> <a class="btn btn-primary btn-large" href="/visualizations">Custom Visualizations <i class="icon-chevron-right icon-white"></i></a></p>
      </div>
